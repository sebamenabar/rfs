...
def parse_option():
    ...
    parser.add_argument("--cosine_factor", type=int, default=3)
    ...
    # meta setting
    parser.add_argument(
        "--n_test_runs", type=int, default=600, metavar="N", help="Number of test runs"
    )
    parser.add_argument(
        "--n_ways",
        type=int,
    ...
    parser.add_argument(
        "--n_shots", type=int, default=1, metavar="N", help="Number of shots in test"
    )
    parser.add_argument(
    ...
    parser.add_argument("--no_dropblock", default=False, action="store_true")
    ...
    opt.model_name = "{}_{}_lr_{}_trans_{}_bsz_{}_epochs_{}".format(
        opt.model,
        opt.dataset,
        opt.learning_rate,
        # opt.weight_decay,
